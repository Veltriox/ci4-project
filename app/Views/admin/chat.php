                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcam text-end">
                                    <p><a href="<?= site_url('home') ?>">Dashboard</a> <i class="fas fa-caret-right"></i> Chat</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul>
                                        ...
                                        <a href="#">
                                            <div class="message_pre_left">
                                                <div class="message_preview_thumb">
                                                    <img src="<?= base_url('img/') ?>messages/1.jpg" alt="">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="message_pre_left">
                                                <div class="message_preview_thumb">
                                                    <img src="<?= base_url('img/') ?>messages/2.jpg" alt="">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="message_pre_left">
                                                <div class="message_preview_thumb">
                                                    <img src="<?= base_url('img/') ?>messages/3.jpg" alt="">
                                                    <span class="round-10 bg-danger"></span>
                                                </div>
                                                <div class="messges_info">
                                                    <h4>Travor James</h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="message_pre_left">
                                                <div class="message_preview_thumb">
                                                    <img src="<?= base_url('img/') ?>messages/4.jpg" alt="">
                                                    <span class="round-10 bg-danger"></span>
                                                </div>
                                                <div class="messges_info">
                                                    <h4>Travor James</h4>
