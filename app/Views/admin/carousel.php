                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="dashboard_breadcam text-end">
                                <p><a href="<?= site_url('home') ?>">Dashboard</a> <i class="fas fa-caret-right"></i> Carousel</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="<?= base_url('img/') ?>banner.png" class="d-block w-100" alt="...">
                              </div>
                ...
                <div class="col-lg-12">
                    <div class="white_box mb_30">
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                            ...
                            <a class="carousel-control-prev" type="button" data-bs-target="#carouselExampleFade" role="button" data-bs-slide="prev">
                              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                              <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next" type="button" data-bs-target="#carouselExampleFade" role="button" data-bs-slide="next">
                              <span class="carousel-control-next-icon" aria-hidden="true"></span>
                              <span class="sr-only">Next</span>
                            </a>
                          </div>
