                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcam text-end">
                                    <p><a href="<?= site_url('home') ?>">Dashboard</a> <i class="fas fa-caret-right"></i> Mailbox</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="circle-rounded me-3" src="<?= base_url('img/') ?>messages/1.png" alt="" width="30" height="30"> 
