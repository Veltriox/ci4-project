                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcam text-end">
                                    <p><a href="<?= site_url('home') ?>">Dashboard</a> <i class="fas fa-caret-right"></i>Scrollable </p>
                                </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="box_body">
                        <div class="scroll-bar-wrap">
                            <div class="click-drag-handler scroll-demo p-0 ps-container ps-theme-default ps-active-x ps-active-y">
                                <img src="<?= base_url('img/') ?>tilt/1.jpg" alt="" width="800" height="600">
                            </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="card_box box_shadow position-relative mb_30     ">
                        ...
                        <div class="scroll-bar-wrap ">
                            <div class="scrollbar-margins large-margin scroll-demo p-0 ps-container ps-theme-default ps-active-x ps-active-y">
                                <img src="<?= base_url('img/') ?>tilt/2.jpg" alt="" width="800" height="600">
                            </div>
                            </div>
                        </div>
                    </div>
