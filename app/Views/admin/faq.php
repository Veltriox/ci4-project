                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcam text-end">
                                    <p><a href="<?= site_url('home') ?>">Dashboard</a> <i class="fas fa-caret-right"></i> Faq</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion accordion_custom2 mb_50" id="accordion_ex2">
                            <div class="card">
                                <div class="card-header" id="headingOnesquare">
                                    <h2 class="mb-0">
                                        <a href="#" class="btn" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#square" aria-expanded="true"
                                            aria-controls="collapseOne">
                                            Example 0
                                        </a>
                                    </h2>
                                ...
                                <div id="square" class="collapse show" aria-labelledby="headingOnesquare"
                                    data-parent="#accordion_ex2">
                                    <div class="card-body">
                                        <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwosquare">
                                    <h2 class="mb-0">
                                        <a href="#" class="btn collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseTwosquare"
                                            aria-expanded="false" aria-controls="collapseTwosquare">
                                            Example 1
                                        </a>
                                    </h2>
                                </div>
                                <div id="collapseTwosquare" class="collapse" aria-labelledby="headingTwosquare"
                                    data-parent="#accordion_ex2">
                                    <div class="card-body">
                                        <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThreesquare">
                                    <h2 class="mb-0">
                                        <a href="#" class="btn collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseThreesquare"
                                            aria-expanded="false" aria-controls="collapseThreesquare">
                                            Example 2
                                        </a>
                                    </h2>
                                </div>
                                <div id="collapseThreesquare" class="collapse" aria-labelledby="headingThreesquare"
                                    data-parent="#accordion_ex2">
                                    <div class="card-body">
                                        <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree3square">
                                    <h2 class="mb-0">
                                        <a href="#" class="btn collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseThree3square"
                                            aria-expanded="false" aria-controls="collapseThreesquare">
                                            Example 3
                                        </a>
                                    </h2>
                                </div>
                                <div id="collapseThree3square" class="collapse" aria-labelledby="headingThree3square"
                                    data-parent="#accordion_ex2">
                                    <div class="card-body">
                                        <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree3square">
                                    <h2 class="mb-0">
                                        <a href="#" class="btn collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseThree4square"
                                            aria-expanded="false" aria-controls="collapseThreesquare">
                                            Example 4
                                        </a>
                                    </h2>
                                </div>
                                <div id="collapseThree4square" class="collapse" aria-labelledby="headingThree3square"
                                    data-parent="#accordion_ex2">
                                    <div class="card-body">
                                        <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree3square">
                                    <h2 class="mb-0">
                                        <a href="#" class="btn collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseThree5square"
                                            aria-expanded="false" aria-controls="collapseThreesquare">
                                            Example 5
                                        </a>
                                    </h2>
                                </div>
                                <div id="collapseThree5square" class="collapse" aria-labelledby="headingThree3square"
                                    data-parent="#accordion_ex2">
                                    <div class="card-body">
                                        <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.
